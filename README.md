...
game in your browser; that is all. See [LICENSE](LICENSE).

"AxolotLink" and "Suiyoo Games" are trade marks of the author. Clones, reskins,
ports and forks are not permitted.

The repository is public so that the game can be played from a browser, not so
that its contents can be re-used.
